python ovnet_train.py --train_on=chinese --log_dir=log/l2_64/ch1 --max_steps=50000 --transform=False --image_width=64 --image_height=64 --batch_size=8 --data_dir=../data/chinese1 --chinese1=True --use_iou=False
