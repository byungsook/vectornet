...
# fidelity
# python pathnet_train.py --train_on=fidelity --log_dir=log/no_trans_128/fidelity_1024_c128 --max_steps=50000 --image_width=128 --image_height=128 --batch_size=16 --initial_learning_rate=0.005 --data_dir=../data/fidelity
# python pathnet_train.py --train_on=fidelity --log_dir=log/no_trans_64/fidelity_256_c64 --max_steps=50000 --original_size=256 --image_width=64 --image_height=64 --batch_size=16 --initial_learning_rate=0.005 --data_dir=../data/fidelity
