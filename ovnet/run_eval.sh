# python ovnet_eval_sketch.py --train_on=qdraw --eval_dir=eval/l2_128/qdraw/chandelier_test   --data_dir=../data/qdraw_chandelier_128 --checkpoint_dir=model/l2_128/qdraw/chandelier --batch_size=16 --max_images=16 --num_epoch=1 --threshold=0.5 --image_width=128 --image_height=128 --file_list=test.txt
# python ovnet_eval_sketch.py --train_on=qdraw --eval_dir=eval/l2_128/qdraw/chandelier_train  --data_dir=../data/qdraw_elephant_128   --checkpoint_dir=model/l2_128/qdraw/elephant   --batch_size=16 --max_images=16 --num_epoch=1 --threshold=0.5 --image_width=128 --image_height=128 --file_list=train.txt
# python ovnet_eval_sketch.py --train_on=qdraw --eval_dir=eval/l2_128/qdraw/elephant_test     --data_dir=../data/qdraw_mix_128        --checkpoint_dir=model/l2_128/qdraw/mix        --batch_size=16 --max_images=16 --num_epoch=1 --threshold=0.5 --image_width=128 --image_height=128 --file_list=test.txt
# python ovnet_eval_sketch.py --train_on=qdraw --eval_dir=eval/l2_128/qdraw/elephant_train    --data_dir=../data/qdraw_chandelier_128 --checkpoint_dir=model/l2_128/qdraw/chandelier --batch_size=16 --max_images=16 --num_epoch=1 --threshold=0.5 --image_width=128 --image_height=128 --file_list=train.txt
python ovnet_eval_sketch.py --train_on=qdraw --eval_dir=eval/l2_128/qdraw/mix_test          --data_dir=../data/qdraw_mix_128_test   --checkpoint_dir=model/l2_128/qdraw/elephant   --batch_size=16 --max_images=16 --num_epoch=1 --threshold=0.5 --image_width=128 --image_height=128 --file_list=test.txt
python ovnet_eval_sketch.py --train_on=qdraw --eval_dir=eval/l2_128/qdraw/mix_train         --data_dir=../data/qdraw_mix_128        --checkpoint_dir=model/l2_128/qdraw/mix        --batch_size=16 --max_images=16 --num_epoch=1 --threshold=0.5 --image_width=128 --image_height=128 --file_list=train.txt
