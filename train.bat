...
python main.py --archi=path --tag=win --dataset=multi    --height=128 --width=128 --lr=0.002
...
python main.py --archi=overlap --tag=win --dataset=multi    --height=128 --width=128 --lr=0.002