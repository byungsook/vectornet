...
def postprocess():
    ...
    with open(stat_path, 'r') as f:
        while True:
            ...
            name, num_labels, diff_labels, duration = line.split()
    ...
    print('min/max/avg. paths: %d,%d,%.3f' % (min_paths, max_paths, sum_paths/num_files))
